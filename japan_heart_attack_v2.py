...
def show_statistics(df):
    ...
    # Converte o DataFrame para string formatada
    text = desc_stats.to_string()
    
    # Adiciona o texto na tela do gráfico
    plt.text(0.01, 0.99, text, fontsize=10, verticalalignment='top', fontfamily='monospace')
    plt.title("Estatísticas Descritivas do Conjunto de Dados", fontsize=12, fontweight='bold')
...
while running:
    ...
    screen.blit(title_text, (WIDTH // 2 - title_text.get_width() // 3, 50))
